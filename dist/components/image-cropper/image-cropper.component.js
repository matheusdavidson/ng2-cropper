...
/** @nocollapse */
ImageCropper.ctorParameters = function () { return []; };
ImageCropper.propDecorators = {
    'imageUrl': [{ type: core_1.Input },],
    'settings': [{ type: core_1.Input },],
    'cropbox': [{ type: core_1.Input },],
    'loadImageErrorText': [{ type: core_1.Input },],
    'cropperOptions': [{ type: core_1.Input },],
    'image': [{ type: core_1.ViewChild, args: ['image',] },],
    'export': [{ type: core_1.Output },],
